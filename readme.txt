...
* Hỗ trợ hệ thống thứ hạng khách hàng dựa trên tổng chi tiêu tích lũy.
...
3. Vào WooCommerce → RewardX - Thứ hạng để thiết lập các mốc chi tiêu và tên hạng thành viên.
...
* Mỗi hạng gồm tên hiển thị và ngưỡng chi tiêu tối thiểu (tổng tiền đã mua hàng) tính bằng đơn vị tiền tệ của cửa hàng.
